...
# Use resource_path for all bundled files
mic_data_path = resource_path("Frontend/Files/Mic.data")
mic_data_dir = os.path.dirname(mic_data_path)
...
with open(mic_data_path, "r", encoding="utf-8") as f:
    mic_status = f.read()
